...
filenameOvervoltageScenario        = 'tests_december_14_2023.csv';
filenameOvervoltagePrettyScenario  = 'tests_december_14_2023_pretty.csv';
filenameUndervoltageScenario       = 'tests_december_15_2023.csv';
filenameUndervoltagePrettyScenario = 'tests_december_15_2023_pretty.csv';
    ...
    case 1
        ...
        switch selection_scenario
            ...
            case 1
                ...
                % Import the data
                table = readtable(strcat(folder_csv, filesep, filenameOvervoltageScenario), opts);
                ...
                fileMATName = filenameOvervoltageScenario; % name MAT-file
            ...
            case 2
                ...
                % Import the data
                table = readtable(strcat(folder_csv, filesep, filenameOvervoltagePrettyScenario), opts);
                ...
                fileMATName = filenameOvervoltagePrettyScenario; % name MAT-file
                fileMATName = erase(fileMATName,'.csv'); % Delete substrings within strings
            ...
            case 3
                ...
                % Import the data
                table = readtable(strcat(folder_csv, filesep, filenameUndervoltageScenario), opts);
                ...
                fileMATName = filenameUndervoltageScenario; % name MAT-file
                fileMATName = erase(fileMATName,'.csv'); % Delete substrings within strings
            ...
            case 4
                ...
                % Import the data
                table = readtable(strcat(folder_csv, filesep, filenameUndervoltagePrettyScenario), opts);
                ...
                fileMATName = filenameUndervoltagePrettyScenario; % name MAT-file
                fileMATName = erase(fileMATName,'.csv'); % Delete substrings within strings
    	...
    	for i = 1 : length(time_vec) %#ok<ALIGN>
            ...
            switch channelId_vec(i)
                ...
                case 'TH_TEMP_0_DTU'
                    ...
                    % Data relative to this signal
                    th_temp_0_dtu_vec = [th_temp_0_dtu_vec; time_vec(i), samplesTimestamp_vec(i), samplesvalues_vec(i)];
                    
                case 'TH_FLOW_1_DTU'
                    
                    % Data relative to this signal
                    th_flow_1_dtu_vec = [th_flow_1_dtu_vec; time_vec(i), samplesTimestamp_vec(i), samplesvalues_vec(i)];
                
                case 'TH_FWD_1_DTU'
                    
                    % Data relative to this signal
                    th_fwd_1_dtu_vec = [th_fwd_1_dtu_vec; time_vec(i), samplesTimestamp_vec(i), samplesvalues_vec(i)];
                    
                case 'TH_RET_1_DTU'
                    
                    % Data relative to this signal
                    th_ret_1_dtu_vec = [th_ret_1_dtu_vec; time_vec(i), samplesTimestamp_vec(i), samplesvalues_vec(i)];
                    
                case 'TH_FWD_2_DTU'
                    
                    % Data relative to this signal
                    th_fwd_2_dtu_vec = [th_fwd_2_dtu_vec; time_vec(i), samplesTimestamp_vec(i), samplesvalues_vec(i)];
                    
                case 'TH_RET_2_DTU'
                    
                    % Data relative to this signal
                    th_ret_2_dtu_vec = [th_ret_2_dtu_vec; time_vec(i), samplesTimestamp_vec(i), samplesvalues_vec(i)];
                    
                case 'TH_FWD_3_DTU'
                    
                    % Data relative to this signal
                    th_fwd_3_dtu_vec = [th_fwd_3_dtu_vec; time_vec(i), samplesTimestamp_vec(i), samplesvalues_vec(i)];
                    
                case 'TH_RET_3_DTU'
                    
                    % Data relative to this signal
                    th_ret_3_dtu_vec = [th_ret_3_dtu_vec; time_vec(i), samplesTimestamp_vec(i), samplesvalues_vec(i)];
                    
                case 'THERMAL_LOAD_DTU'
                    
                    % Data relative to this signal
                    thermal_load_dtu_vec = [thermal_load_dtu_vec; time_vec(i), samplesTimestamp_vec(i), samplesvalues_vec(i)];
                    
                case 'THERMAL_SOURCE_DTU'
                    
                    % Data relative to this signal
                    thermal_source_dtu_vec = [thermal_source_dtu_vec; time_vec(i), samplesTimestamp_vec(i), samplesvalues_vec(i)];
                    
                case 'CHP_HEAT_OUT_RSE'
                    
                    % Data relative to this signal
                    chp_heat_out_rse_vec = [chp_heat_out_rse_vec; time_vec(i), samplesTimestamp_vec(i), samplesvalues_vec(i)];
        ...
        save(file_name_MAT, 'active_power_el_sin_out_vec', 'reactive_power_el_sin_out_vec', 'active_power_ref_el_sin_out_vec', ...
            ...
            'active_power_el_rse_out_vec', 'reactive_power_el_rse_out_vec', 'voltage_ref_rse_out_vec', ...
            'frequency_ref_rse_out_vec', 'rse_chp_m_ea_watt_vec', 'cres_temperature1_m_ea_celsius_vec', ...
